...
namespace BizfreeApp.Migrations
{
    ...
    [Migration("20250526084624_SyncRefreshTokenManualAdd")]
    partial class SyncRefreshTokenManualAdd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BizfreeApp.Models.CompanyUser", b =>
                {
                    ...
                    b.HasOne("BizfreeApp.Models.Department", "DepartmentNavigation")
                        .WithMany("CompanyUsers")
            ...
            modelBuilder.Entity("BizfreeApp.Models.Taskpriority", b =>
                {
                    b.HasOne("BizfreeApp.Models.Company", "Company")
                        ...
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("taskpriorities_company_id_fkey");
            ...
            modelBuilder.Entity("BizfreeApp.Models.Taskstatus", b =>
                {
                    b.HasOne("BizfreeApp.Models.Company", "Company")
                        ...
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("taskstatus_company_id_fkey");
